...
ReprojectionCostFunctor_3dof_numerical::ReprojectionCostFunctor_3dof_numerical(const Eigen::Vector3d &world_position,
                                                                               const Eigen::Vector2d &pixel_matched)
    : world_position_(world_position), pixel_matched_(pixel_matched) {}
void ReprojectionCostFunctor_3dof_numerical::SetPoseBaseToCamera(const Eigen::Isometry3d &pose_base_to_camera) {
...
void ReprojectionCostFunctor_3dof_numerical::SetCameraIntrinsicParameters(const double fx, const double fy,
...
ReprojectionCostFunctor_6dof_numerical::ReprojectionCostFunctor_6dof_numerical(const Eigen::Vector3d &world_position,
                                                                               const Eigen::Vector2d &pixel_matched)
    : world_position_(world_position), pixel_matched_(pixel_matched) {}
void ReprojectionCostFunctor_6dof_numerical::SetCameraIntrinsicParameters(const double fx, const double fy,
                                                                          const double cx, const double cy) {
