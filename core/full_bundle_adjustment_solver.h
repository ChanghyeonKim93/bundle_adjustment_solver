...
using FullBlockMat1x1 = std::vector<std::vector<_BA_Mat11>>;
using FullBlockMat1x3 = std::vector<std::vector<_BA_Mat13>>;
using FullBlockMat3x1 = std::vector<std::vector<_BA_Mat31>>;
using FullBlockMat3x3 = std::vector<std::vector<_BA_Mat33>>;
using FullBlockMat6x3 = std::vector<std::vector<_BA_Mat63>>;
using FullBlockMat3x6 = std::vector<std::vector<_BA_Mat36>>;
using FullBlockMat6x6 = std::vector<std::vector<_BA_Mat66>>;
...
class FullBundleAdjustmentSolver {
 public:
  ...
  void AddObservation(const _BA_Index index_camera, _BA_Pose *related_pose,
 ...
 private:                               // Problem sizes
  ...
  _BA_Size_t num_optimization_poses_;   // # of optimization poses
  _BA_Size_t num_optimization_points_;  // # of optimization mappoints
